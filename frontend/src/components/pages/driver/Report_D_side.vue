<template>
    <div class="min-h-screen bg-white px-6 pt-[max(2.5rem,env(safe-area-inset-top))] pb-[max(env(safe-area-inset-bottom),2.5rem)] flex flex-col relative" style="max-width: 420px; margin: 0 auto; font-family: 'Roboto', sans-serif;">
      ...
      <div class="mb-4">
        <div class="text-base font-semibold mb-1 text-left " style="font-family: 'Poppins', sans-serif; color: #8C8C8C;">Passenger Information</div><hr>
        <div class="mb-3">
          <label class="block text-base font-semibold mt-2 mb-1 text-left" style="font-family: 'Poppins', sans-serif; color: #333333;">Passenger Name</label>
          <input type="text" :value="passenger.name" disabled class="w-full border border-gray-200 bg-[#F5F5F5] px-4 py-3 rounded-lg text-base font-semibold text-[#333333]" style="font-family: 'Poppins', sans-serif;" />
        </div>
        <div class="mb-3">
          <label class="block text-base font-semibold mb-1 text-left" style="font-family: 'Poppins', sans-serif; color: #333333;">Phone Number</label>
          <input type="text" :value="passenger.phone" disabled class="w-full border border-gray-200 bg-[#F5F5F5] px-4 py-3 rounded-lg text-base font-semibold text-[#333333]" style="font-family: 'Poppins', sans-serif;" />
        </div>
      </div>
      <hr class="my-2">
